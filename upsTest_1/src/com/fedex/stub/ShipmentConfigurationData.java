...
public class ShipmentConfigurationData  implements java.io.Serializable {
    ...
    private com.fedex.stub.DangerousGoodsDetail[] dangerousGoodsPackageConfigurations;

    public ShipmentConfigurationData() {
    }

    public ShipmentConfigurationData(
           com.fedex.stub.DangerousGoodsDetail[] dangerousGoodsPackageConfigurations) {
     ...
     * with identical dangerous goods commodities.
     */
    public com.fedex.stub.DangerousGoodsDetail[] getDangerousGoodsPackageConfigurations() {
     ...
     * with identical dangerous goods commodities.
     */
    public void setDangerousGoodsPackageConfigurations(com.fedex.stub.DangerousGoodsDetail[] dangerousGoodsPackageConfigurations) {
        this.dangerousGoodsPackageConfigurations = dangerousGoodsPackageConfigurations;
    }

    public com.fedex.stub.DangerousGoodsDetail getDangerousGoodsPackageConfigurations(int i) {
        return this.dangerousGoodsPackageConfigurations[i];
    }

    public void setDangerousGoodsPackageConfigurations(int i, com.fedex.stub.DangerousGoodsDetail _value) {
