...
public class LiabilityCoverageDetail  implements java.io.Serializable {
    private com.fedex.stub.LiabilityCoverageType coverageType;

    /* Identifies the Liability Coverage Amount. For Jan 2010 this
     * value represents coverage amount per pound */
    private com.fedex.stub.Money coverageAmount;

    public LiabilityCoverageDetail() {
    }

    public LiabilityCoverageDetail(
           com.fedex.stub.LiabilityCoverageType coverageType,
           com.fedex.stub.Money coverageAmount) {
     ...
     * @return coverageType
     */
    public com.fedex.stub.LiabilityCoverageType getCoverageType() {
        return coverageType;
    }
     ...
     * @param coverageType
     */
    public void setCoverageType(com.fedex.stub.LiabilityCoverageType coverageType) {
        this.coverageType = coverageType;
    }
     ...
     * value represents coverage amount per pound
     */
    public com.fedex.stub.Money getCoverageAmount() {
     ...
     * value represents coverage amount per pound
     */
    public void setCoverageAmount(com.fedex.stub.Money coverageAmount) {
        this.coverageAmount = coverageAmount;
    }
