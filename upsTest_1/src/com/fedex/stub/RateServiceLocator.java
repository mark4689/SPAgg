...
public class RateServiceLocator extends org.apache.axis.client.Service implements com.fedex.stub.RateService {
    ...
    public com.fedex.stub.RatePortType getRateServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.fedex.stub.RatePortType getRateServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.fedex.stub.RateServiceSoapBindingStub _stub = new com.fedex.stub.RateServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.fedex.stub.RatePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.fedex.stub.RateServiceSoapBindingStub _stub = new com.fedex.stub.RateServiceSoapBindingStub(new java.net.URL(RateServicePort_address), this);
                _stub.setPortName(getRateServicePortWSDDServiceName());
                return _stub;
            }
        }
