...
public class Dimensions  implements java.io.Serializable {
    ...
    private com.fedex.stub.LinearUnits units;
    ...
    public Dimensions(
           ...
           com.fedex.stub.LinearUnits units) {
           this.length = length;
           this.width = width;
           this.height = height;
           this.units = units;
     ...
     * @return units
     */
    public com.fedex.stub.LinearUnits getUnits() {
        return units;
    }
     ...
     * @param units
     */
    public void setUnits(com.fedex.stub.LinearUnits units) {
        this.units = units;
    }
