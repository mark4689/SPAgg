...
public class DocTabContentZone001  implements java.io.Serializable {
    private com.fedex.stub.DocTabZoneSpecification[] docTabZoneSpecifications;

    public DocTabContentZone001() {
    }

    public DocTabContentZone001(
           com.fedex.stub.DocTabZoneSpecification[] docTabZoneSpecifications) {
     ...
     */
    public com.fedex.stub.DocTabZoneSpecification[] getDocTabZoneSpecifications() {
        return docTabZoneSpecifications;
    }
     ...
     */
    public void setDocTabZoneSpecifications(com.fedex.stub.DocTabZoneSpecification[] docTabZoneSpecifications) {
        this.docTabZoneSpecifications = docTabZoneSpecifications;
    }

    public com.fedex.stub.DocTabZoneSpecification getDocTabZoneSpecifications(int i) {
        return this.docTabZoneSpecifications[i];
    }

    public void setDocTabZoneSpecifications(int i, com.fedex.stub.DocTabZoneSpecification _value) {
