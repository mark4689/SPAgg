...
public class ShippingDocumentSpecification  implements java.io.Serializable {
     ...
     * shipper. */
    private com.fedex.stub.RequestedShippingDocumentType[] shippingDocumentTypes;

    private com.fedex.stub.CertificateOfOriginDetail certificateOfOrigin;

    private com.fedex.stub.CommercialInvoiceDetail commercialInvoiceDetail;

    /* Specifies the production of each package-level custom document
     * (the same specification is used for all packages). */
    private com.fedex.stub.CustomDocumentDetail[] customPackageDocumentDetail;

    /* Specifies the production of a shipment-level custom document. */
    private com.fedex.stub.CustomDocumentDetail[] customShipmentDocumentDetail;

    private com.fedex.stub.ExportDeclarationDetail exportDeclarationDetail;

    private com.fedex.stub.GeneralAgencyAgreementDetail generalAgencyAgreementDetail;

    private com.fedex.stub.NaftaCertificateOfOriginDetail naftaCertificateOfOriginDetail;

    /* Specifies the production of the OP-900 document for hazardous
     * materials packages. */
    private com.fedex.stub.Op900Detail op900Detail;

    /* Specifies the production of the 1421c document for dangerous
     * goods shipment. */
    private com.fedex.stub.DangerousGoodsShippersDeclarationDetail dangerousGoodsShippersDeclarationDetail;

    /* Specifies the production of the OP-900 document for hazardous
     * materials. */
    private com.fedex.stub.FreightAddressLabelDetail freightAddressLabelDetail;

    /* Specifies the production of the return instructions document. */
    private com.fedex.stub.ReturnInstructionsDetail returnInstructionsDetail;

    public ShippingDocumentSpecification() {
    }

    public ShippingDocumentSpecification(
           com.fedex.stub.RequestedShippingDocumentType[] shippingDocumentTypes,
           com.fedex.stub.CertificateOfOriginDetail certificateOfOrigin,
           com.fedex.stub.CommercialInvoiceDetail commercialInvoiceDetail,
           com.fedex.stub.CustomDocumentDetail[] customPackageDocumentDetail,
           com.fedex.stub.CustomDocumentDetail[] customShipmentDocumentDetail,
           com.fedex.stub.ExportDeclarationDetail exportDeclarationDetail,
           com.fedex.stub.GeneralAgencyAgreementDetail generalAgencyAgreementDetail,
           com.fedex.stub.NaftaCertificateOfOriginDetail naftaCertificateOfOriginDetail,
           com.fedex.stub.Op900Detail op900Detail,
           com.fedex.stub.DangerousGoodsShippersDeclarationDetail dangerousGoodsShippersDeclarationDetail,
           com.fedex.stub.FreightAddressLabelDetail freightAddressLabelDetail,
           com.fedex.stub.ReturnInstructionsDetail returnInstructionsDetail) {
     ...
     * shipper.
     */
    public com.fedex.stub.RequestedShippingDocumentType[] getShippingDocumentTypes() {
     ...
     * shipper.
     */
    public void setShippingDocumentTypes(com.fedex.stub.RequestedShippingDocumentType[] shippingDocumentTypes) {
        this.shippingDocumentTypes = shippingDocumentTypes;
    }

    public com.fedex.stub.RequestedShippingDocumentType getShippingDocumentTypes(int i) {
        return this.shippingDocumentTypes[i];
    }

    public void setShippingDocumentTypes(int i, com.fedex.stub.RequestedShippingDocumentType _value) {
     ...
     */
    public com.fedex.stub.CertificateOfOriginDetail getCertificateOfOrigin() {
        return certificateOfOrigin;
    }
     ...
     */
    public void setCertificateOfOrigin(com.fedex.stub.CertificateOfOriginDetail certificateOfOrigin) {
        this.certificateOfOrigin = certificateOfOrigin;
    }
     ...
     */
    public com.fedex.stub.CommercialInvoiceDetail getCommercialInvoiceDetail() {
        return commercialInvoiceDetail;
    }
     ...
     */
    public void setCommercialInvoiceDetail(com.fedex.stub.CommercialInvoiceDetail commercialInvoiceDetail) {
        this.commercialInvoiceDetail = commercialInvoiceDetail;
    }
     ...
     * (the same specification is used for all packages).
     */
    public com.fedex.stub.CustomDocumentDetail[] getCustomPackageDocumentDetail() {
     ...
     * (the same specification is used for all packages).
     */
    public void setCustomPackageDocumentDetail(com.fedex.stub.CustomDocumentDetail[] customPackageDocumentDetail) {
        this.customPackageDocumentDetail = customPackageDocumentDetail;
    }

    public com.fedex.stub.CustomDocumentDetail getCustomPackageDocumentDetail(int i) {
        return this.customPackageDocumentDetail[i];
    }

    public void setCustomPackageDocumentDetail(int i, com.fedex.stub.CustomDocumentDetail _value) {
     ...
     */
    public com.fedex.stub.CustomDocumentDetail[] getCustomShipmentDocumentDetail() {
     ...
     */
    public void setCustomShipmentDocumentDetail(com.fedex.stub.CustomDocumentDetail[] customShipmentDocumentDetail) {
        this.customShipmentDocumentDetail = customShipmentDocumentDetail;
    }

    public com.fedex.stub.CustomDocumentDetail getCustomShipmentDocumentDetail(int i) {
        return this.customShipmentDocumentDetail[i];
    }

    public void setCustomShipmentDocumentDetail(int i, com.fedex.stub.CustomDocumentDetail _value) {
     ...
     */
    public com.fedex.stub.ExportDeclarationDetail getExportDeclarationDetail() {
        return exportDeclarationDetail;
    }
     ...
     */
    public void setExportDeclarationDetail(com.fedex.stub.ExportDeclarationDetail exportDeclarationDetail) {
        this.exportDeclarationDetail = exportDeclarationDetail;
    }
     ...
     */
    public com.fedex.stub.GeneralAgencyAgreementDetail getGeneralAgencyAgreementDetail() {
        return generalAgencyAgreementDetail;
    }
     ...
     */
    public void setGeneralAgencyAgreementDetail(com.fedex.stub.GeneralAgencyAgreementDetail generalAgencyAgreementDetail) {
        this.generalAgencyAgreementDetail = generalAgencyAgreementDetail;
    }
     ...
     */
    public com.fedex.stub.NaftaCertificateOfOriginDetail getNaftaCertificateOfOriginDetail() {
        return naftaCertificateOfOriginDetail;
    }
     ...
     */
    public void setNaftaCertificateOfOriginDetail(com.fedex.stub.NaftaCertificateOfOriginDetail naftaCertificateOfOriginDetail) {
        this.naftaCertificateOfOriginDetail = naftaCertificateOfOriginDetail;
    }
     ...
     * materials packages.
     */
    public com.fedex.stub.Op900Detail getOp900Detail() {
        return op900Detail;
    }
     ...
     * materials packages.
     */
    public void setOp900Detail(com.fedex.stub.Op900Detail op900Detail) {
        this.op900Detail = op900Detail;
    }
     ...
     * goods shipment.
     */
    public com.fedex.stub.DangerousGoodsShippersDeclarationDetail getDangerousGoodsShippersDeclarationDetail() {
     ...
     * goods shipment.
     */
    public void setDangerousGoodsShippersDeclarationDetail(com.fedex.stub.DangerousGoodsShippersDeclarationDetail dangerousGoodsShippersDeclarationDetail) {
        this.dangerousGoodsShippersDeclarationDetail = dangerousGoodsShippersDeclarationDetail;
    }
     ...
     * materials.
     */
    public com.fedex.stub.FreightAddressLabelDetail getFreightAddressLabelDetail() {
     ...
     * materials.
     */
    public void setFreightAddressLabelDetail(com.fedex.stub.FreightAddressLabelDetail freightAddressLabelDetail) {
        this.freightAddressLabelDetail = freightAddressLabelDetail;
    }
     ...
     */
    public com.fedex.stub.ReturnInstructionsDetail getReturnInstructionsDetail() {
     ...
     */
    public void setReturnInstructionsDetail(com.fedex.stub.ReturnInstructionsDetail returnInstructionsDetail) {
        this.returnInstructionsDetail = returnInstructionsDetail;
    }
