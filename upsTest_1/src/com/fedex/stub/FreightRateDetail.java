...
public class FreightRateDetail  implements java.io.Serializable {
    ...
    private com.fedex.stub.FreightRateQuoteType quoteType;

    /* Specifies how total base charge is determined. */
    private com.fedex.stub.FreightBaseChargeCalculationType baseChargeCalculation;

    /* Freight charges which accumulate to the total base charge for
     * the shipment. */
    private com.fedex.stub.FreightBaseCharge[] baseCharges;

    /* Human-readable descriptions of additional information on this
     * shipment rating. */
    private com.fedex.stub.FreightRateNotation[] notations;
    ...
    public FreightRateDetail(
           ...
           com.fedex.stub.FreightRateQuoteType quoteType,
           com.fedex.stub.FreightBaseChargeCalculationType baseChargeCalculation,
           com.fedex.stub.FreightBaseCharge[] baseCharges,
           com.fedex.stub.FreightRateNotation[] notations) {
     ...
     */
    public com.fedex.stub.FreightRateQuoteType getQuoteType() {
        return quoteType;
    }
     ...
     */
    public void setQuoteType(com.fedex.stub.FreightRateQuoteType quoteType) {
        this.quoteType = quoteType;
    }
     ...
     */
    public com.fedex.stub.FreightBaseChargeCalculationType getBaseChargeCalculation() {
     ...
     */
    public void setBaseChargeCalculation(com.fedex.stub.FreightBaseChargeCalculationType baseChargeCalculation) {
        this.baseChargeCalculation = baseChargeCalculation;
    }
     ...
     * the shipment.
     */
    public com.fedex.stub.FreightBaseCharge[] getBaseCharges() {
        return baseCharges;
    }
     ...
     * the shipment.
     */
    public void setBaseCharges(com.fedex.stub.FreightBaseCharge[] baseCharges) {
        this.baseCharges = baseCharges;
    }

    public com.fedex.stub.FreightBaseCharge getBaseCharges(int i) {
        return this.baseCharges[i];
    }

    public void setBaseCharges(int i, com.fedex.stub.FreightBaseCharge _value) {
     ...
     * shipment rating.
     */
    public com.fedex.stub.FreightRateNotation[] getNotations() {
        return notations;
    }
     ...
     * shipment rating.
     */
    public void setNotations(com.fedex.stub.FreightRateNotation[] notations) {
        this.notations = notations;
    }

    public com.fedex.stub.FreightRateNotation getNotations(int i) {
        return this.notations[i];
    }

    public void setNotations(int i, com.fedex.stub.FreightRateNotation _value) {
