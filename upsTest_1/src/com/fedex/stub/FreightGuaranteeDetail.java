...
public class FreightGuaranteeDetail  implements java.io.Serializable {
    private com.fedex.stub.FreightGuaranteeType type;
    ...
    public FreightGuaranteeDetail(
           com.fedex.stub.FreightGuaranteeType type,
           java.util.Date date) {
           this.type = type;
           this.date = date;
    }
     ...
     * @return type
     */
    public com.fedex.stub.FreightGuaranteeType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.stub.FreightGuaranteeType type) {
        this.type = type;
    }
