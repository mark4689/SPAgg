...
public class ServiceSubOptionDetail  implements java.io.Serializable {
    ...
    private com.fedex.stub.FreightGuaranteeType freightGuarantee;
     ...
     * is a variable option on the rate request. */
    private com.fedex.stub.SmartPostIndiciaType smartPostIndicia;

    public ServiceSubOptionDetail() {
    }

    public ServiceSubOptionDetail(
           com.fedex.stub.FreightGuaranteeType freightGuarantee,
           java.lang.String smartPostHubId,
           com.fedex.stub.SmartPostIndiciaType smartPostIndicia) {
     ...
     * is applied to the rate quote.
     */
    public com.fedex.stub.FreightGuaranteeType getFreightGuarantee() {
     ...
     * is applied to the rate quote.
     */
    public void setFreightGuarantee(com.fedex.stub.FreightGuaranteeType freightGuarantee) {
        this.freightGuarantee = freightGuarantee;
    }
     ...
     * is a variable option on the rate request.
     */
    public com.fedex.stub.SmartPostIndiciaType getSmartPostIndicia() {
     ...
     * is a variable option on the rate request.
     */
    public void setSmartPostIndicia(com.fedex.stub.SmartPostIndiciaType smartPostIndicia) {
        this.smartPostIndicia = smartPostIndicia;
    }
