...
public class RatedPackageDetail  implements java.io.Serializable {
     ...
     * provided). */
    private com.fedex.stub.TrackingId[] trackingIds;
    ...
    private com.fedex.stub.Money effectiveNetDiscount;

    /* Ground COD is shipment level. */
    private com.fedex.stub.Money adjustedCodCollectionAmount;

    private com.fedex.stub.OversizeClassType oversizeClass;

    /* Rate data that are tied to a specific package and rate type
     * combination. */
    private com.fedex.stub.PackageRateDetail packageRateDetail;

    public RatedPackageDetail() {
    }

    public RatedPackageDetail(
           com.fedex.stub.TrackingId[] trackingIds,
           org.apache.axis.types.NonNegativeInteger groupNumber,
           com.fedex.stub.Money effectiveNetDiscount,
           com.fedex.stub.Money adjustedCodCollectionAmount,
           com.fedex.stub.OversizeClassType oversizeClass,
           com.fedex.stub.PackageRateDetail packageRateDetail) {
     ...
     * provided).
     */
    public com.fedex.stub.TrackingId[] getTrackingIds() {
        return trackingIds;
    }
     ...
     * provided).
     */
    public void setTrackingIds(com.fedex.stub.TrackingId[] trackingIds) {
        this.trackingIds = trackingIds;
    }

    public com.fedex.stub.TrackingId getTrackingIds(int i) {
        return this.trackingIds[i];
    }

    public void setTrackingIds(int i, com.fedex.stub.TrackingId _value) {
     ...
     */
    public com.fedex.stub.Money getEffectiveNetDiscount() {
     ...
     */
    public void setEffectiveNetDiscount(com.fedex.stub.Money effectiveNetDiscount) {
        this.effectiveNetDiscount = effectiveNetDiscount;
    }
     ...
     */
    public com.fedex.stub.Money getAdjustedCodCollectionAmount() {
     ...
     */
    public void setAdjustedCodCollectionAmount(com.fedex.stub.Money adjustedCodCollectionAmount) {
        this.adjustedCodCollectionAmount = adjustedCodCollectionAmount;
    }
     ...
     */
    public com.fedex.stub.OversizeClassType getOversizeClass() {
        return oversizeClass;
    }
     ...
     * @param oversizeClass
     */
    public void setOversizeClass(com.fedex.stub.OversizeClassType oversizeClass) {
        this.oversizeClass = oversizeClass;
    }
     ...
     * combination.
     */
    public com.fedex.stub.PackageRateDetail getPackageRateDetail() {
     ...
     * combination.
     */
    public void setPackageRateDetail(com.fedex.stub.PackageRateDetail packageRateDetail) {
        this.packageRateDetail = packageRateDetail;
    }
