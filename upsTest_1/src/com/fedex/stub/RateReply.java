...
public class RateReply  implements java.io.Serializable {
    ...
    private com.fedex.stub.NotificationSeverityType highestSeverity;

    /* The descriptive data regarding the results of the submitted
     * transaction. */
    private com.fedex.stub.Notification[] notifications;
    ...
    private com.fedex.stub.RateReplyDetail[] rateReplyDetails;

    public RateReply() {
    }

    public RateReply(
           com.fedex.stub.NotificationSeverityType highestSeverity,
           com.fedex.stub.Notification[] notifications,
           com.fedex.stub.TransactionDetail transactionDetail,
           com.fedex.stub.VersionId version,
           com.fedex.stub.RateReplyDetail[] rateReplyDetails) {
     ...
     * returned in this reply.
     */
    public com.fedex.stub.NotificationSeverityType getHighestSeverity() {
     ...
     * returned in this reply.
     */
    public void setHighestSeverity(com.fedex.stub.NotificationSeverityType highestSeverity) {
        this.highestSeverity = highestSeverity;
    }
     ...
     * transaction.
     */
    public com.fedex.stub.Notification[] getNotifications() {
     ...
     * transaction.
     */
    public void setNotifications(com.fedex.stub.Notification[] notifications) {
        this.notifications = notifications;
    }

    public com.fedex.stub.Notification getNotifications(int i) {
        return this.notifications[i];
    }

    public void setNotifications(int i, com.fedex.stub.Notification _value) {
     ...
     * a separate entry in this array for each service being compared.
     */
    public com.fedex.stub.RateReplyDetail[] getRateReplyDetails() {
     ...
     * a separate entry in this array for each service being compared.
     */
    public void setRateReplyDetails(com.fedex.stub.RateReplyDetail[] rateReplyDetails) {
        this.rateReplyDetails = rateReplyDetails;
    }

    public com.fedex.stub.RateReplyDetail getRateReplyDetails(int i) {
        return this.rateReplyDetails[i];
    }

    public void setRateReplyDetails(int i, com.fedex.stub.RateReplyDetail _value) {
