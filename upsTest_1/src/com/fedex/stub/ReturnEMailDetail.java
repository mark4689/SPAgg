...
public class ReturnEMailDetail  implements java.io.Serializable {
    ...
    private com.fedex.stub.ReturnEMailAllowedSpecialServiceType[] allowedSpecialServices;
    ...
    public ReturnEMailDetail(
           ...
           com.fedex.stub.ReturnEMailAllowedSpecialServiceType[] allowedSpecialServices) {
     ...
     * controlled by this list.
     */
    public com.fedex.stub.ReturnEMailAllowedSpecialServiceType[] getAllowedSpecialServices() {
     ...
     * controlled by this list.
     */
    public void setAllowedSpecialServices(com.fedex.stub.ReturnEMailAllowedSpecialServiceType[] allowedSpecialServices) {
        this.allowedSpecialServices = allowedSpecialServices;
    }

    public com.fedex.stub.ReturnEMailAllowedSpecialServiceType getAllowedSpecialServices(int i) {
        return this.allowedSpecialServices[i];
    }

    public void setAllowedSpecialServices(int i, com.fedex.stub.ReturnEMailAllowedSpecialServiceType _value) {
