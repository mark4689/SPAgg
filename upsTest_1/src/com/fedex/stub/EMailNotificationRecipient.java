...
public class EMailNotificationRecipient  implements java.io.Serializable {
     ...
     * shipment. */
    private com.fedex.stub.EMailNotificationRecipientType EMailNotificationRecipientType;

    /* The email address to send the notification to */
    private java.lang.String EMailAddress;

    /* The types of email notifications being requested for this recipient. */
    private com.fedex.stub.EMailNotificationEventType[] notificationEventsRequested;

    /* The format of the email notification. */
    private com.fedex.stub.EMailNotificationFormatType format;

    /* The language/locale to be used in this email notification. */
    private com.fedex.stub.Localization localization;

    public EMailNotificationRecipient() {
    }

    public EMailNotificationRecipient(
           com.fedex.stub.EMailNotificationRecipientType EMailNotificationRecipientType,
           java.lang.String EMailAddress,
           com.fedex.stub.EMailNotificationEventType[] notificationEventsRequested,
           com.fedex.stub.EMailNotificationFormatType format,
           com.fedex.stub.Localization localization) {
     ...
     * shipment.
     */
    public com.fedex.stub.EMailNotificationRecipientType getEMailNotificationRecipientType() {
     ...
     * shipment.
     */
    public void setEMailNotificationRecipientType(com.fedex.stub.EMailNotificationRecipientType EMailNotificationRecipientType) {
        this.EMailNotificationRecipientType = EMailNotificationRecipientType;
    }
     ...
     */
    public com.fedex.stub.EMailNotificationEventType[] getNotificationEventsRequested() {
     ...
     */
    public void setNotificationEventsRequested(com.fedex.stub.EMailNotificationEventType[] notificationEventsRequested) {
        this.notificationEventsRequested = notificationEventsRequested;
    }

    public com.fedex.stub.EMailNotificationEventType getNotificationEventsRequested(int i) {
        return this.notificationEventsRequested[i];
    }

    public void setNotificationEventsRequested(int i, com.fedex.stub.EMailNotificationEventType _value) {
     ...
     */
    public com.fedex.stub.EMailNotificationFormatType getFormat() {
        return format;
    }
     ...
     */
    public void setFormat(com.fedex.stub.EMailNotificationFormatType format) {
        this.format = format;
    }
     ...
     */
    public com.fedex.stub.Localization getLocalization() {
        return localization;
    }
     ...
     */
    public void setLocalization(com.fedex.stub.Localization localization) {
        this.localization = localization;
    }
