...
public class EMailNotificationDetail  implements java.io.Serializable {
    ...
    private com.fedex.stub.EMailNotificationRecipient[] recipients;
    ...
    public EMailNotificationDetail(
           ...
           com.fedex.stub.EMailNotificationRecipient[] recipients) {
     ...
     * of the email and events to be notified on
     */
    public com.fedex.stub.EMailNotificationRecipient[] getRecipients() {
        return recipients;
    }
     ...
     * of the email and events to be notified on
     */
    public void setRecipients(com.fedex.stub.EMailNotificationRecipient[] recipients) {
        this.recipients = recipients;
    }

    public com.fedex.stub.EMailNotificationRecipient getRecipients(int i) {
        return this.recipients[i];
    }

    public void setRecipients(int i, com.fedex.stub.EMailNotificationRecipient _value) {
