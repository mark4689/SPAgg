...
public class RatedShipmentDetail  implements java.io.Serializable {
    ...
    private com.fedex.stub.ShipmentRateDetail shipmentRateDetail;

    /* The package-level data for this rate type. */
    private com.fedex.stub.RatedPackageDetail[] ratedPackages;
    ...
    public RatedShipmentDetail(
           ...
           com.fedex.stub.ShipmentRateDetail shipmentRateDetail,
           com.fedex.stub.RatedPackageDetail[] ratedPackages) {
     ...
     */
    public com.fedex.stub.ShipmentRateDetail getShipmentRateDetail() {
     ...
     */
    public void setShipmentRateDetail(com.fedex.stub.ShipmentRateDetail shipmentRateDetail) {
        this.shipmentRateDetail = shipmentRateDetail;
    }
     ...
     */
    public com.fedex.stub.RatedPackageDetail[] getRatedPackages() {
     ...
     */
    public void setRatedPackages(com.fedex.stub.RatedPackageDetail[] ratedPackages) {
        this.ratedPackages = ratedPackages;
    }

    public com.fedex.stub.RatedPackageDetail getRatedPackages(int i) {
        return this.ratedPackages[i];
    }

    public void setRatedPackages(int i, com.fedex.stub.RatedPackageDetail _value) {
