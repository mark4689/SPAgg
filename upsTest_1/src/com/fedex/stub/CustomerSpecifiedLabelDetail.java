...
public class CustomerSpecifiedLabelDetail  implements java.io.Serializable {
     ...
     * NONE type). */
    private com.fedex.stub.DocTabContent docTabContent;

    /* Controls the position of the customer specified content relative
     * to the FedEx portion. */
    private com.fedex.stub.RelativeVerticalPositionType customContentPosition;

    private com.fedex.stub.CustomLabelDetail customContent;

    private com.fedex.stub.ConfigurableLabelReferenceEntry[] configurableReferenceEntries;

    /* Controls which data/sections will be suppressed. */
    private com.fedex.stub.LabelMaskableDataType[] maskedData;
    ...
    private com.fedex.stub.SecondaryBarcodeType secondaryBarcode;

    private com.fedex.stub.Localization termsAndConditionsLocalization;

    /* Controls the number of additional copies of supplemental labels. */
    private com.fedex.stub.AdditionalLabelsDetail[] additionalLabels;
    ...
    public CustomerSpecifiedLabelDetail(
           com.fedex.stub.DocTabContent docTabContent,
           com.fedex.stub.RelativeVerticalPositionType customContentPosition,
           com.fedex.stub.CustomLabelDetail customContent,
           com.fedex.stub.ConfigurableLabelReferenceEntry[] configurableReferenceEntries,
           com.fedex.stub.LabelMaskableDataType[] maskedData,
           com.fedex.stub.SecondaryBarcodeType secondaryBarcode,
           com.fedex.stub.Localization termsAndConditionsLocalization,
           com.fedex.stub.AdditionalLabelsDetail[] additionalLabels,
     ...
     * NONE type).
     */
    public com.fedex.stub.DocTabContent getDocTabContent() {
     ...
     * NONE type).
     */
    public void setDocTabContent(com.fedex.stub.DocTabContent docTabContent) {
        this.docTabContent = docTabContent;
    }
     ...
     * to the FedEx portion.
     */
    public com.fedex.stub.RelativeVerticalPositionType getCustomContentPosition() {
     ...
     * to the FedEx portion.
     */
    public void setCustomContentPosition(com.fedex.stub.RelativeVerticalPositionType customContentPosition) {
        this.customContentPosition = customContentPosition;
    }
     ...
     */
    public com.fedex.stub.CustomLabelDetail getCustomContent() {
        return customContent;
    }
     ...
     * @param customContent
     */
    public void setCustomContent(com.fedex.stub.CustomLabelDetail customContent) {
        this.customContent = customContent;
    }
     ...
     */
    public com.fedex.stub.ConfigurableLabelReferenceEntry[] getConfigurableReferenceEntries() {
        return configurableReferenceEntries;
    }
     ...
     */
    public void setConfigurableReferenceEntries(com.fedex.stub.ConfigurableLabelReferenceEntry[] configurableReferenceEntries) {
        this.configurableReferenceEntries = configurableReferenceEntries;
    }

    public com.fedex.stub.ConfigurableLabelReferenceEntry getConfigurableReferenceEntries(int i) {
        return this.configurableReferenceEntries[i];
    }

    public void setConfigurableReferenceEntries(int i, com.fedex.stub.ConfigurableLabelReferenceEntry _value) {
     ...
     */
    public com.fedex.stub.LabelMaskableDataType[] getMaskedData() {
        return maskedData;
    }
     ...
     */
    public void setMaskedData(com.fedex.stub.LabelMaskableDataType[] maskedData) {
        this.maskedData = maskedData;
    }

    public com.fedex.stub.LabelMaskableDataType getMaskedData(int i) {
        return this.maskedData[i];
    }

    public void setMaskedData(int i, com.fedex.stub.LabelMaskableDataType _value) {
     ...
     * that the primary barcode produced by FedEx has the correct SCNC.
     */
    public com.fedex.stub.SecondaryBarcodeType getSecondaryBarcode() {
     ...
     * that the primary barcode produced by FedEx has the correct SCNC.
     */
    public void setSecondaryBarcode(com.fedex.stub.SecondaryBarcodeType secondaryBarcode) {
        this.secondaryBarcode = secondaryBarcode;
    }
     ...
     */
    public com.fedex.stub.Localization getTermsAndConditionsLocalization() {
        return termsAndConditionsLocalization;
    }
     ...
     */
    public void setTermsAndConditionsLocalization(com.fedex.stub.Localization termsAndConditionsLocalization) {
        this.termsAndConditionsLocalization = termsAndConditionsLocalization;
    }
     ...
     */
    public com.fedex.stub.AdditionalLabelsDetail[] getAdditionalLabels() {
     ...
     */
    public void setAdditionalLabels(com.fedex.stub.AdditionalLabelsDetail[] additionalLabels) {
        this.additionalLabels = additionalLabels;
    }

    public com.fedex.stub.AdditionalLabelsDetail getAdditionalLabels(int i) {
        return this.additionalLabels[i];
    }

    public void setAdditionalLabels(int i, com.fedex.stub.AdditionalLabelsDetail _value) {
