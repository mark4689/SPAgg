...
public class NaftaCertificateOfOriginDetail  implements java.io.Serializable {
    private com.fedex.stub.ShippingDocumentFormat format;

    private com.fedex.stub.DateRange blanketPeriod;

    /* Indicates which Party (if any) from the shipment is to be used
     * as the source of importer data on the NAFTA COO form. */
    private com.fedex.stub.NaftaImporterSpecificationType importerSpecification;

    /* Contact information for "Authorized Signature" area of form. */
    private com.fedex.stub.Contact signatureContact;

    private com.fedex.stub.NaftaProducerSpecificationType producerSpecification;

    private com.fedex.stub.NaftaProducer[] producers;

    private com.fedex.stub.CustomerImageUsage[] customerImageUsages;

    public NaftaCertificateOfOriginDetail() {
    }

    public NaftaCertificateOfOriginDetail(
           com.fedex.stub.ShippingDocumentFormat format,
           com.fedex.stub.DateRange blanketPeriod,
           com.fedex.stub.NaftaImporterSpecificationType importerSpecification,
           com.fedex.stub.Contact signatureContact,
           com.fedex.stub.NaftaProducerSpecificationType producerSpecification,
           com.fedex.stub.NaftaProducer[] producers,
           com.fedex.stub.CustomerImageUsage[] customerImageUsages) {
           this.format = format;
     ...
     * @return format
     */
    public com.fedex.stub.ShippingDocumentFormat getFormat() {
        return format;
    }
     ...
     * @param format
     */
    public void setFormat(com.fedex.stub.ShippingDocumentFormat format) {
        this.format = format;
    }
     ...
     */
    public com.fedex.stub.DateRange getBlanketPeriod() {
        return blanketPeriod;
    }
     ...
     * @param blanketPeriod
     */
    public void setBlanketPeriod(com.fedex.stub.DateRange blanketPeriod) {
        this.blanketPeriod = blanketPeriod;
    }
     ...
     * as the source of importer data on the NAFTA COO form.
     */
    public com.fedex.stub.NaftaImporterSpecificationType getImporterSpecification() {
     ...
     * as the source of importer data on the NAFTA COO form.
     */
    public void setImporterSpecification(com.fedex.stub.NaftaImporterSpecificationType importerSpecification) {
        this.importerSpecification = importerSpecification;
    }
     ...
     */
    public com.fedex.stub.Contact getSignatureContact() {
     ...
     */
    public void setSignatureContact(com.fedex.stub.Contact signatureContact) {
        this.signatureContact = signatureContact;
    }
     ...
     */
    public com.fedex.stub.NaftaProducerSpecificationType getProducerSpecification() {
        return producerSpecification;
    }
     ...
     */
    public void setProducerSpecification(com.fedex.stub.NaftaProducerSpecificationType producerSpecification) {
        this.producerSpecification = producerSpecification;
    }
     ...
     * @return producers
     */
    public com.fedex.stub.NaftaProducer[] getProducers() {
        return producers;
    }
     ...
     * @param producers
     */
    public void setProducers(com.fedex.stub.NaftaProducer[] producers) {
        this.producers = producers;
    }

    public com.fedex.stub.NaftaProducer getProducers(int i) {
        return this.producers[i];
    }

    public void setProducers(int i, com.fedex.stub.NaftaProducer _value) {
     ...
     */
    public com.fedex.stub.CustomerImageUsage[] getCustomerImageUsages() {
        return customerImageUsages;
    }
     ...
     */
    public void setCustomerImageUsages(com.fedex.stub.CustomerImageUsage[] customerImageUsages) {
        this.customerImageUsages = customerImageUsages;
    }

    public com.fedex.stub.CustomerImageUsage getCustomerImageUsages(int i) {
        return this.customerImageUsages[i];
    }

    public void setCustomerImageUsages(int i, com.fedex.stub.CustomerImageUsage _value) {
