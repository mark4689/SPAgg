...
public class FlatbedTrailerDetail  implements java.io.Serializable {
    private com.fedex.stub.FlatbedTrailerOption[] options;

    public FlatbedTrailerDetail() {
    }

    public FlatbedTrailerDetail(
           com.fedex.stub.FlatbedTrailerOption[] options) {
     ...
     * @return options
     */
    public com.fedex.stub.FlatbedTrailerOption[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.fedex.stub.FlatbedTrailerOption[] options) {
        this.options = options;
    }

    public com.fedex.stub.FlatbedTrailerOption getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.fedex.stub.FlatbedTrailerOption _value) {
