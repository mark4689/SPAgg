...
public class EdtCommodityTax  implements java.io.Serializable {
    ...
    private com.fedex.stub.EdtTaxDetail[] taxes;
    ...
    public EdtCommodityTax(
           ...
           com.fedex.stub.EdtTaxDetail[] taxes) {
     ...
     * @return taxes
     */
    public com.fedex.stub.EdtTaxDetail[] getTaxes() {
        return taxes;
    }
     ...
     * @param taxes
     */
    public void setTaxes(com.fedex.stub.EdtTaxDetail[] taxes) {
        this.taxes = taxes;
    }

    public com.fedex.stub.EdtTaxDetail getTaxes(int i) {
        return this.taxes[i];
    }

    public void setTaxes(int i, com.fedex.stub.EdtTaxDetail _value) {
        this.taxes[i] = _value;
    }
