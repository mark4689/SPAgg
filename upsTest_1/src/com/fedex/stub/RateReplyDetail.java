...
public class RateReplyDetail  implements java.io.Serializable {
    ...
    private com.fedex.stub.DayOfWeekType deliveryDayOfWeek;

    private java.util.Calendar deliveryTimestamp;

    private com.fedex.stub.CommitDetail[] commitDetails;
    ...
    private com.fedex.stub.SignatureOptionType signatureOption;

    private com.fedex.stub.ReturnedRateType actualRateType;

    /* Each element contains all rate data for a single rate type. */
    private com.fedex.stub.RatedShipmentDetail[] ratedShipmentDetails;
    ...
    public RateReplyDetail(
           ...
           com.fedex.stub.DayOfWeekType deliveryDayOfWeek,
           java.util.Calendar deliveryTimestamp,
           com.fedex.stub.CommitDetail[] commitDetails,
           ...
           com.fedex.stub.SignatureOptionType signatureOption,
           com.fedex.stub.ReturnedRateType actualRateType,
           com.fedex.stub.RatedShipmentDetail[] ratedShipmentDetails) {
     ...
     */
    public com.fedex.stub.DayOfWeekType getDeliveryDayOfWeek() {
        return deliveryDayOfWeek;
    }
     ...
     */
    public void setDeliveryDayOfWeek(com.fedex.stub.DayOfWeekType deliveryDayOfWeek) {
        this.deliveryDayOfWeek = deliveryDayOfWeek;
    }
     ...
     */
    public com.fedex.stub.CommitDetail[] getCommitDetails() {
        return commitDetails;
    }
     ...
     * @param commitDetails
     */
    public void setCommitDetails(com.fedex.stub.CommitDetail[] commitDetails) {
        this.commitDetails = commitDetails;
    }

    public com.fedex.stub.CommitDetail getCommitDetails(int i) {
        return this.commitDetails[i];
    }

    public void setCommitDetails(int i, com.fedex.stub.CommitDetail _value) {
     ...
     * with other service features in the shipment.
     */
    public com.fedex.stub.SignatureOptionType getSignatureOption() {
     ...
     * with other service features in the shipment.
     */
    public void setSignatureOption(com.fedex.stub.SignatureOptionType signatureOption) {
        this.signatureOption = signatureOption;
    }
     ...
     */
    public com.fedex.stub.ReturnedRateType getActualRateType() {
        return actualRateType;
    }
     ...
     */
    public void setActualRateType(com.fedex.stub.ReturnedRateType actualRateType) {
        this.actualRateType = actualRateType;
    }
     ...
     */
    public com.fedex.stub.RatedShipmentDetail[] getRatedShipmentDetails() {
     ...
     */
    public void setRatedShipmentDetails(com.fedex.stub.RatedShipmentDetail[] ratedShipmentDetails) {
        this.ratedShipmentDetails = ratedShipmentDetails;
    }

    public com.fedex.stub.RatedShipmentDetail getRatedShipmentDetails(int i) {
        return this.ratedShipmentDetails[i];
    }

    public void setRatedShipmentDetails(int i, com.fedex.stub.RatedShipmentDetail _value) {
