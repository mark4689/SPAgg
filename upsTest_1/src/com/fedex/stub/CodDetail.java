...
public class CodDetail  implements java.io.Serializable {
    private com.fedex.stub.Money codCollectionAmount;

    /* Specifies the details of the charges are to be added to the
     * COD collect amount. */
    private com.fedex.stub.CodAddTransportationChargesDetail addTransportationChargesDetail;

    /* Identifies the type of funds FedEx should collect upon package
     * delivery */
    private com.fedex.stub.CodCollectionType collectionType;
    ...
    private com.fedex.stub.Party codRecipient;
     ...
     * payment of the COD. */
    private com.fedex.stub.ContactAndAddress financialInstitutionContactAndAddress;
    ...
    private com.fedex.stub.CodReturnReferenceIndicatorType referenceIndicator;

    /* Only used with multi-piece COD shipments sent in multiple transactions.
     * Required on last transaction only. */
    private com.fedex.stub.TrackingId returnTrackingId;

    public CodDetail() {
    }

    public CodDetail(
           com.fedex.stub.Money codCollectionAmount,
           com.fedex.stub.CodAddTransportationChargesDetail addTransportationChargesDetail,
           com.fedex.stub.CodCollectionType collectionType,
           com.fedex.stub.Party codRecipient,
           com.fedex.stub.ContactAndAddress financialInstitutionContactAndAddress,
           java.lang.String remitToName,
           com.fedex.stub.CodReturnReferenceIndicatorType referenceIndicator,
           com.fedex.stub.TrackingId returnTrackingId) {
     ...
     */
    public com.fedex.stub.Money getCodCollectionAmount() {
        return codCollectionAmount;
    }
     ...
     */
    public void setCodCollectionAmount(com.fedex.stub.Money codCollectionAmount) {
        this.codCollectionAmount = codCollectionAmount;
    }
     ...
     * COD collect amount.
     */
    public com.fedex.stub.CodAddTransportationChargesDetail getAddTransportationChargesDetail() {
     ...
     * COD collect amount.
     */
    public void setAddTransportationChargesDetail(com.fedex.stub.CodAddTransportationChargesDetail addTransportationChargesDetail) {
        this.addTransportationChargesDetail = addTransportationChargesDetail;
    }
     ...
     * delivery
     */
    public com.fedex.stub.CodCollectionType getCollectionType() {
     ...
     * delivery
     */
    public void setCollectionType(com.fedex.stub.CodCollectionType collectionType) {
        this.collectionType = collectionType;
    }
     ...
     * that prints the COD receipt.
     */
    public com.fedex.stub.Party getCodRecipient() {
        return codRecipient;
    }
     ...
     * that prints the COD receipt.
     */
    public void setCodRecipient(com.fedex.stub.Party codRecipient) {
        this.codRecipient = codRecipient;
    }
     ...
     * payment of the COD.
     */
    public com.fedex.stub.ContactAndAddress getFinancialInstitutionContactAndAddress() {
     ...
     * payment of the COD.
     */
    public void setFinancialInstitutionContactAndAddress(com.fedex.stub.ContactAndAddress financialInstitutionContactAndAddress) {
        this.financialInstitutionContactAndAddress = financialInstitutionContactAndAddress;
    }
     ...
     * the COD return shipping label.
     */
    public com.fedex.stub.CodReturnReferenceIndicatorType getReferenceIndicator() {
     ...
     * the COD return shipping label.
     */
    public void setReferenceIndicator(com.fedex.stub.CodReturnReferenceIndicatorType referenceIndicator) {
        this.referenceIndicator = referenceIndicator;
    }
     ...
     * Required on last transaction only.
     */
    public com.fedex.stub.TrackingId getReturnTrackingId() {
     ...
     * Required on last transaction only.
     */
    public void setReturnTrackingId(com.fedex.stub.TrackingId returnTrackingId) {
        this.returnTrackingId = returnTrackingId;
    }
