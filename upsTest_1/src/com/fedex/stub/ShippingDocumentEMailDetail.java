...
public class ShippingDocumentEMailDetail  implements java.io.Serializable {
    ...
    private com.fedex.stub.ShippingDocumentEMailRecipient[] EMailRecipients;

    /* Identifies the convention by which documents are to be grouped
     * as e-mail attachments. */
    private com.fedex.stub.ShippingDocumentEMailGroupingType grouping;

    public ShippingDocumentEMailDetail() {
    }

    public ShippingDocumentEMailDetail(
           com.fedex.stub.ShippingDocumentEMailRecipient[] EMailRecipients,
           com.fedex.stub.ShippingDocumentEMailGroupingType grouping) {
     ...
     */
    public com.fedex.stub.ShippingDocumentEMailRecipient[] getEMailRecipients() {
     ...
     */
    public void setEMailRecipients(com.fedex.stub.ShippingDocumentEMailRecipient[] EMailRecipients) {
        this.EMailRecipients = EMailRecipients;
    }

    public com.fedex.stub.ShippingDocumentEMailRecipient getEMailRecipients(int i) {
        return this.EMailRecipients[i];
    }

    public void setEMailRecipients(int i, com.fedex.stub.ShippingDocumentEMailRecipient _value) {
     ...
     * as e-mail attachments.
     */
    public com.fedex.stub.ShippingDocumentEMailGroupingType getGrouping() {
        return grouping;
    }
     ...
     * as e-mail attachments.
     */
    public void setGrouping(com.fedex.stub.ShippingDocumentEMailGroupingType grouping) {
        this.grouping = grouping;
    }
