...
public class NaftaProducer  implements java.io.Serializable {
    ...
    private com.fedex.stub.Party producer;
     ...
     * @return producer
     */
    public com.fedex.stub.Party getProducer() {
        return producer;
    }
     ...
     * @param producer
     */
    public void setProducer(com.fedex.stub.Party producer) {
        this.producer = producer;
    }
