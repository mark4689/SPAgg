...
public class EtdDetail  implements java.io.Serializable {
    ...
    private com.fedex.stub.RequestedShippingDocumentType[] requestedDocumentCopies;

    private com.fedex.stub.UploadDocumentDetail[] documents;

    private com.fedex.stub.UploadDocumentReferenceDetail[] documentReferences;

    public EtdDetail() {
    }

    public EtdDetail(
           com.fedex.stub.RequestedShippingDocumentType[] requestedDocumentCopies,
           com.fedex.stub.UploadDocumentDetail[] documents,
           com.fedex.stub.UploadDocumentReferenceDetail[] documentReferences) {
     ...
     * be copied back to the shipper in the shipment result data.
     */
    public com.fedex.stub.RequestedShippingDocumentType[] getRequestedDocumentCopies() {
     ...
     * be copied back to the shipper in the shipment result data.
     */
    public void setRequestedDocumentCopies(com.fedex.stub.RequestedShippingDocumentType[] requestedDocumentCopies) {
        this.requestedDocumentCopies = requestedDocumentCopies;
    }

    public com.fedex.stub.RequestedShippingDocumentType getRequestedDocumentCopies(int i) {
        return this.requestedDocumentCopies[i];
    }

    public void setRequestedDocumentCopies(int i, com.fedex.stub.RequestedShippingDocumentType _value) {
     ...
     * @return documents
     */
    public com.fedex.stub.UploadDocumentDetail[] getDocuments() {
        return documents;
    }
     ...
     * @param documents
     */
    public void setDocuments(com.fedex.stub.UploadDocumentDetail[] documents) {
        this.documents = documents;
    }

    public com.fedex.stub.UploadDocumentDetail getDocuments(int i) {
        return this.documents[i];
    }

    public void setDocuments(int i, com.fedex.stub.UploadDocumentDetail _value) {
     ...
     */
    public com.fedex.stub.UploadDocumentReferenceDetail[] getDocumentReferences() {
        return documentReferences;
    }
     ...
     */
    public void setDocumentReferences(com.fedex.stub.UploadDocumentReferenceDetail[] documentReferences) {
        this.documentReferences = documentReferences;
    }

    public com.fedex.stub.UploadDocumentReferenceDetail getDocumentReferences(int i) {
        return this.documentReferences[i];
    }

    public void setDocumentReferences(int i, com.fedex.stub.UploadDocumentReferenceDetail _value) {
