...
//            packageWeight = "15.0";
    ...
    public void process(PartyType shipper, PartyType recipient, PackageType pkg) {
...
//    }
    ...
    private RequestedPackageLineItem addRequestedPackageLineItem(PackageType pkg) {
        ...
        lineItem.setWeight(new Weight(WeightUnits.LB, new BigDecimal(pkg.getPackageWeight())));
        lineItem.setInsuredValue(new Money("USD", new BigDecimal("100.00")));
        lineItem.setDimensions(new Dimensions(new NonNegativeInteger(pkg.getPackageH()), 
                new NonNegativeInteger(pkg.getPackageL()), 
                new NonNegativeInteger(pkg.getPackageW()), LinearUnits.IN));
        return lineItem;
    }
...
//    public ResponseType UniversalResponse(){
//        
//    }
}
