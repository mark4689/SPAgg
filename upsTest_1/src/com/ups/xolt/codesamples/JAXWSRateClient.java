...
public class JAXWSRateClient {	    
	...
	private static final String TOOL_OR_WEB_SERVICE_NAME = "Rate Web Service";
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println(rateResponse.getRatedShipment().get(0).getTotalCharges().getMonetaryValue());
            System.out.println(rateResponse.getRatedShipment().get(0).getTotalCharges().getSubType());
            System.out.println(rateResponse.getRatedShipment().get(0).getServiceOptionsCharges().getMonetaryValue());
            System.out.println(rateResponse.getRatedShipment().get(0).getServiceOptionsCharges().getSubType());
            updateResultsToFile(statusCode, description);
        } catch(Exception e) {
